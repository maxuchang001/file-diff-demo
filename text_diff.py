...
def generate_text_diff(file1_path, file2_path):
    """
    ...
    try:
        ...
        # 生成差异对比 HTML
        html = difflib.HtmlDiff(tabsize=4, wrapcolumn=80).make_file(
            old_lines,
            new_lines,
            fromdesc=file1_name,
            todesc=file2_name,
...
def test_text_diff():
    ...
    # 调用转换函数
    status, html_content = generate_text_diff(
        file1_path,
        file2_path,
    )
